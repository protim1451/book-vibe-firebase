    ...
    return (
        <section className="my-12 mx-4 lg:mx-32">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
                ...
                <div className="p-6 border rounded-lg shadow-md">
                    <h3 className="text-xl font-semibold mb-4">Step 2: Add to Read List or Wishlist</h3>
                    <p>Once you find a product, you can choose to add it to your Read List or Wishlist for future reference.</p>
                </div>

                {/* Step 3: View Product Details */}
                <div className="p-6 border rounded-lg shadow-md">
                    <h3 className="text-xl font-semibold mb-4">Step 3: View Product Details</h3>
                    <p>Click on any product to view its details. You can read reviews, check availability, and get detailed descriptions.</p>
                </div>

                {/* Step 4: Sign Up / Log In */}
                <div className="p-6 border rounded-lg shadow-md">
                    <h3 className="text-xl font-semibold mb-4">Step 4: Sign Up / Log In</h3>
                    <p>Create an account or log in to access your personalized Read List and Wishlist. Your account keeps track of your progress and preferences.</p>
                </div>
